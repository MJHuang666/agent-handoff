# Project Role Workflow Usage Guide

This guide covers `project-role-workflow` Skill v1.4.0: initialization, role handoff, Agent replacement, pause and recovery, state inspection, and task acceptance.
...
See the [Skill instructions](../shared/.agents/skills/project-role-workflow/SKILL.md), [initialization reference](../shared/.agents/skills/project-role-workflow/references/initialization.md), [protocol](../shared/.agents/skills/project-role-workflow/references/protocol.md), and [installation guide](../distribution/INSTALL.md) for details.
