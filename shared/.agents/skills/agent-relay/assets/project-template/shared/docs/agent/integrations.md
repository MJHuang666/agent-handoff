...
| DeepSeek Harness | 是 | 根目录 `AGENTS.md` + `.agents/skills/agent-relay/`；需启用 `dsh-agent-instructions` 和文件系统 Skill 加载 | 是 | 静态验证完成，待真实会话 | 本地源码 / 2026-09-17 |
| OpenCode | 是 | 根目录 `AGENTS.md` + `.agents/skills/agent-relay/` | 是 | 已验证 | 1.3.17 / 2026-09-17 |
