...
- The lock is short-lived and local to one repository checkout: `agent-relay.lock` in the resolved Git directory (including worktrees), otherwise `.agent-relay.lock` at the repository root.
